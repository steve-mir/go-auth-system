...
func (s *Server) bulkUserActionsHandler(c *gin.Context) {
	...
	var req interfaces.BulkUserActionRequest
...
func (s *Server) getAllUserSessionsHandler(c *gin.Context) {
	...
	req := &interfaces.GetSessionsRequest{
		Page:      page,
		Limit:     limit,
		UserID:    userID,
		SortBy:    sortBy,
...
func (s *Server) deleteUserSessionHandler(c *gin.Context) {
	...
	if sessionIDStr == "" {
		s.badRequestResponse(c, "Session ID is required", nil)
		return
	}
...
func (s *Server) bulkRoleAssignHandler(c *gin.Context) {
	...
	var req interfaces.BulkRoleAssignRequest
	if !s.bindAndValidate(c, &req) {
		return
	}
...
func (s *Server) getAuditEventsHandler(c *gin.Context) {
	...
	req := &interfaces.GetAuditEventsRequest{
		Page:      page,
		Limit:     limit,
		EventType: eventType,
		SortBy:    sortBy,
...
func (s *Server) updateConfigHandler(c *gin.Context) {
	...
	var req interfaces.UpdateConfigurationRequest
	if !s.bindAndValidate(c, &req) {
		return
	}
...
func (s *Server) createAlertHandler(c *gin.Context) {
	...
	var req interfaces.CreateAlertRequest
	if !s.bindAndValidate(c, &req) {
		return
	}
...
func (s *Server) updateAlertHandler(c *gin.Context) {
	...
	if alertIDStr == "" {
		s.badRequestResponse(c, "Alert ID is required", nil)
		return
	}
	...
	var req interfaces.UpdateAlertRequest
	if !s.bindAndValidate(c, &req) {
		return
	}
...
func (s *Server) updateNotificationSettingsHandler(c *gin.Context) {
	...
	var req interfaces.UpdateNotificationSettingsRequest
	if !s.bindAndValidate(c, &req) {
		return
	}
