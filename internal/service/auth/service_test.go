...
// func (m *mockUserRepository) CreateUser(ctx context.Context, user *interfaces.CreateUserData) (*interfaces.UserData, error) {
// 	args := m.Called(ctx, user)
// 	if args.Get(0) == nil {
// 		return nil, args.Error(1)
// 	}
// 	return args.Get(0).(*interfaces.UserData), args.Error(1)
// }

// func (m *mockUserRepository) GetUserByEmail(ctx context.Context, email string) (*interfaces.UserData, error) {
...
// func (m *mockUserRepository) GetUserByUsername(ctx context.Context, username string) (*interfaces.UserData, error) {
...
// func (m *mockUserRepository) GetUserByID(ctx context.Context, userID string) (*interfaces.UserData, error) {
...
// func (m *mockUserRepository) UpdateUserLoginInfo(ctx context.Context, userID string, info *interfaces.LoginInfo) error {
...
// func (m *mockSessionRepository) CreateSession(ctx context.Context, session *interfaces.SessionData) error {
// 	args := m.Called(ctx, session)
// 	return args.Error(0)
// }

// func (m *mockSessionRepository) GetSession(ctx context.Context, sessionID string) (*interfaces.SessionData, error) {
// 	args := m.Called(ctx, sessionID)
// 	if args.Get(0) == nil {
// 		return nil, args.Error(1)
// 	}
// 	return args.Get(0).(*interfaces.SessionData), args.Error(1)
// }

// func (m *mockSessionRepository) UpdateSession(ctx context.Context, sessionID string, session *interfaces.SessionData) error {
...
// func (m *mockSessionRepository) GetUserSessions(ctx context.Context, userID string) ([]*interfaces.SessionData, error) {
// 	args := m.Called(ctx, userID)
// 	if args.Get(0) == nil {
// 		return nil, args.Error(1)
// 	}
...
// 		createdUser := &interfaces.UserData{
// 			ID:        userID,
// 			Email:     req.Email,
...
// 		existingUser := &interfaces.UserData{
// 			ID:    uuid.New().String(),
// 			Email: req.Email,
// 		}
...
// 		sessionRepo.On("CreateSession", ctx, mock.AnythingOfType("*auth.interfaces.SessionData")).Return(nil)
...
// 		sessionRepo.On("GetUserSessions", ctx, claims.UserID).Return([]*interfaces.SessionData{}, nil)
...
// 		sessionRepo.On("GetUserSessions", ctx, userID).Return([]*interfaces.SessionData{}, nil)
