...
type QueueRepository interface {
	Enqueue(ctx context.Context, email *EmailQueue) error
	Dequeue(ctx context.Context, limit int) ([]*EmailQueue, error)
	Update(ctx context.Context, email *EmailQueue) error
	Delete(ctx context.Context, id string) error
	GetByID(ctx context.Context, id string) (*EmailQueue, error)
	GetPendingRetries(ctx context.Context) ([]*EmailQueue, error)
}
