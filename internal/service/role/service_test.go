...
// func (m *MockRepository) CreateRole(ctx context.Context, role *interfaces.Role) error {
...
// func (m *MockRepository) GetRoleByID(ctx context.Context, roleID uuid.UUID) (*interfaces.Role, error) {
// 	args := m.Called(ctx, roleID)
// 	return args.Get(0).(*interfaces.Role), args.Error(1)
// }

// func (m *MockRepository) GetRoleByName(ctx context.Context, name string) (*interfaces.Role, error) {
...
// func (m *MockRepository) UpdateRole(ctx context.Context, role *interfaces.Role) error {
// 	args := m.Called(ctx, role)
// 	if args.Get(0) == nil {
// 		role.UpdatedAt = time.Now()
// 	}
...
// func (m *MockRepository) ListRoles(ctx context.Context, limit, offset int) ([]*interfaces.Role, error) {
...
// func (m *MockRepository) GetUserRoles(ctx context.Context, userID uuid.UUID) ([]*interfaces.Role, error) {
...
// 				repo.On("CreateRole", mock.Anything, mock.AnythingOfType("*interfaces.Role.Role")).Return(nil)
// 			},
// 			expectError: false,
// 		},
// 		{
...
// 		Permissions: []interfaces.Permission{{Resource: "user", Action: "read", Scope: "own"}},
// 	}

// 	newName := "power-user"
// 	newDescription := "Power user with extended permissions"
// 	newPermissions := []interfaces.Permission{
...
// 	repo.On("UpdateRole", mock.Anything, mock.AnythingOfType("*interfaces.Role.Role")).Return(nil)
...
// 	emptyData, err := MarshalPermissions([]interfaces.Permission{})
// 	require.NoError(t, err)
